...
- [ ] A1: Add missing commands to safe-commands.txt — *safe-commands.txt contains ln, dirname, basename, [, command (64 entries total); marketplace.json version bumped to 1.15.0; all existing tests pass*
